...
const Signup = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-[linear-gradient(135deg,_#cad2c5_0%,_#e0e1dd_30%,_#c6ac8f_100%)] text-[#0d1b2a] lg:grid lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
          ...
          <div className="rounded-[32px] border border-[#cad2c5] bg-[#e0e1dd]/88 p-6 shadow-[0_30px_80px_rgba(13,27,42,0.16)] backdrop-blur-xl sm:p-8">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-md text-sm leading-7 text-[#3d405b] sm:text-base">
                Build your profile, start fresh conversations, and step into a
                cleaner chat experience from day one.
              </p>
            </div>

            <div className="mt-6 grid grid-cols-1 gap-3 text-xs font-medium text-[#1b263b] sm:grid-cols-3">
              <span className="rounded-full border border-[#81b29a] bg-[#cad2c5] px-3 py-1.5 text-center text-[#4c956c]">
                Fast onboarding
              </span>
              <span className="rounded-full border border-[#5b8e7d] bg-[#81b29a]/20 px-3 py-1.5 text-center text-[#3d405b]">
                Smooth auth flow
              </span>
              <span className="rounded-full border border-[#c6ac8f] bg-[#f4e285] px-3 py-1.5 text-center text-[#3d405b]">
                Ready in minutes
              </span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-10 space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <User className="pointer-events-none absolute left-4 top-1/2 size-5 -translate-y-1/2 text-[#5b8e7d]" />
                  <input
                    type="text"
      ...
      <AuthImagePattern
        title="Start with a profile that feels ready."
        subtitle="Create your account once, then move into secure messaging, clean navigation, and a chat experience that already feels polished."
      />
    </div>
  );
};
